...
const floatingSnippets = [
  {
    ...
    style: "border-2 border-[#ff0096] bg-[#0d0015]",
    rotate: -3,
  },
  {
    text: "98% engagement rate",
    position: "top-0 right-0 md:-right-4",
    style: "bg-[#623bc7]",
    rotate: 2,
  },
  {
    text: "66 nieuwe prospects",
    position: "bottom-20 left-0 md:-left-8",
    style: "bg-white text-[#0d0015]",
    rotate: -2,
  },
  {
    text: "Automation afgerond",
    position: "bottom-16 right-0 md:-right-6",
    style: "bg-[#ff0096]",
    rotate: 3,
  },
]
      ...
      >
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Geen verhalen. Gewoon resultaat.
          </h2>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          {floatingSnippets.map((snippet, index) => (
            <motion.div
              ...
              className={`absolute z-10 px-4 py-2 rounded-lg text-sm font-semibold shadow-xl text-white ${snippet.position} ${snippet.style}`}
