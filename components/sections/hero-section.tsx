          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-white/55 text-xs">gingen je voor</p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <p className="text-white/55 text-[11px] font-semibold uppercase tracking-widest">Forester OS</p>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-white/55 text-[11px] truncate">{stat.label}</p>
              ...
              <div className="mt-4 pt-4 border-t border-white/8">
                <div className="flex items-center justify-between">
                  <p className="text-white/55 text-xs">Bijgewerkt 2 min geleden</p>
