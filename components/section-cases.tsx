  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden">
        <Image src={c.img} alt={c.imgAlt} fill sizes="(max-width: 1024px) 100vw, 640px" className="object-cover transition-transform duration-[700ms] ease-out group-hover:scale-[1.04]" />
