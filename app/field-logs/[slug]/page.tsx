      ...
      <main>
        ...
        <section className="relative pt-36 pb-0 px-5 sm:px-8 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <Link href="/field-logs" className="inline-flex items-center gap-2 text-white/55 hover:text-white text-sm mb-8 transition-colors">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <time dateTime={post.dateTime} className="text-white/55 text-xs">{post.date}</time>
              <span className="text-white/20 text-xs">·</span>
              <span className="text-white/55 text-xs">{post.readTime} leestijd</span>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            {relatedPosts.length > 0 && (
              <div className="mb-16 border-t border-white/8 pt-12">
                <p className="text-white/55 text-xs font-semibold tracking-widest uppercase mb-6">Meer lezen</p>
