...
export const metadata = {
  title: "Gratis Website APK | Forester OS",
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-xl mx-auto">
              We kijken samen wat er beter kan en wat het je oplevert. Binnen 48 uur heb je een persoonlijk rapport.
            </p>
          </div>
